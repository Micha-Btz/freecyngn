...
# DNS Server Chaos Computer Club
$IPTABLES -t nat -I OUTPUT -p tcp --dport 53 -j DNAT --to-destination 213.73.91.35:53
$IPTABLES -t nat -I OUTPUT -p udp --dport 53 -j DNAT --to-destination 213.73.91.35:53
